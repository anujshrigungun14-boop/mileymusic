    ...
    if (isBot && username) {
        try {
            ...
            if (profile) {
                ...
                let description = escapeHtml(profile.about || `View ${rawDisplayName}'s profile on MiLey.`);
                ...
                const imageUrl = escapeHtml(profile.avatar_url || 'https://miley.app/assets/appicon.png');
